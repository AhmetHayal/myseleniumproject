...
//        Click all  the buttons
        ...
        waitFor(1);
        driver.findElement(By.id("onclick")).click();//This first click will be used for "onblur" button
        waitFor(1);
        ...
        new Actions(driver).pause(Duration.ofSeconds(1)).contextClick(oncontextmenu)
                ...
                .pause(Duration.ofSeconds(2)).click(onfocus)
                ...
                .pause(Duration.ofSeconds(1)).click(onmousedown)//This click will trigger "onmouseleave" element
                .pause(Duration.ofSeconds(1)).click(onmousedown)//This click will trigger "onmousedown" element
                .build().perform();

//        Assert all buttons clicked
        int noOfButtons = driver.findElements(By.xpath("//button")).size();
        int noOfEventTriggeredMessages = driver.findElements(By.xpath("//p[.='Event Triggered']")).size();
        Assert.assertEquals(noOfButtons, noOfEventTriggeredMessages);
    }
}
