...
//      asserting the logout i successful
//      strategy: if the current url contains "auth", then it means the user is back on the login page
        Assert.assertTrue(driver.getCurrentUrl().contains("auth"));
//      strategy: if Loginh5 element is displayed, then it means the user is back on the login page
//        isDisplayed() returns TRUE if the element is DISPLAYED
//        isDisplayed() returns FALSE if the element is NOT DISPLAYED
